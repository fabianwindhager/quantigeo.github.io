...
Für die Erstellung eines demographischen Regionsprofiles importieren wir Bevölkerungsstände und Wanderungsdaten. Mit `filter()` wählen wir aus dem Datensatz nur die Tiroler Gemeinden aus.
...
Mit `left_join()` verbinden wir beide Datensätze.
...
-   **Anteile** beschreiben die Struktur der Gesamtbevölkerung. Der Anteil einer Altersgruppe an der Gesamtbevölkerung ergibt einen Prozentwert und wird wie folgt berechnet:
...
-   **Quotienten** messen die demographische „Belastung“ der Erwerbsbevölkerung, Die Quotienten beziehen sich auf die erwerbsfähige Bevölkerung (15–64 Jahre) und werden interpretiert als "auf 100 Erwerbstätige kommen x Personen die nicht Teil der erwerbsfähigen Bevölkerung sind.".
